  ...
  return (
    <div
      className={cn(
        ...
        // before
        "before:absolute before:inset-0 before:h-full before:w-full before:opacity-40 before:[background-image:radial-gradient(circle_at_bottom_center,var(--secondary),transparent_70%)]",
